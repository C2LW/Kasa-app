        ...
        <div className="carousel__btn">
            <button type="button" className="carousel__btn--prev" onClick={prev} aria-label="Image précédente">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" 
                    stroke-linejoin="round" className="carousel__btn--svg lucide lucide-chevron-left-icon lucide-chevron-left">
            ...
            <button type="button" className="carousel__btn--next" onClick={next} aria-label="Image suivante" >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" 
                    stroke-linejoin="round" className="carousel__btn--svg lucide lucide-chevron-right-icon lucide-chevron-right">
